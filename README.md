...
1. **Install the Ingress Controller**:
    Navigate to the [`ingress-controller`](./ingress-controller/) directory and follow the provided instructions to install the NGINX Ingress Controller in your cluster. For more information, you can refer to the [NGINX Ingress Controller documentation](https://kubernetes.github.io/ingress-nginx/).
